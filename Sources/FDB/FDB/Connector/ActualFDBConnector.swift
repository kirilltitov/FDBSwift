...
public extension FDB {
    final class Connector: FDBConnector {
        ...
        private func initNetwork() throws -> Self {
            class Box<T> {
                let value: T
            ...
            pthread_create(
                ...
                { ptr in
                    ...
                    let _ptr = ptr!
#endif
                    Unmanaged<Box<Connector>>.fromOpaque(_ptr).takeRetainedValue().value.semaphore.signal()
                    return nil
                },
                ptr
            )
        ...
        /// Inits FDB database
        private func initDB() throws -> Self {
        ...
        ///
        private func checkIsAlive() throws -> Self {
